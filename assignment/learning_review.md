...
### 收获
---
除了基本的数据分析技能，数据思维也是我在这次数据课中的一个收获。数据分析中的五步法，就是一个很好的思考方式。它清晰地说明了如何将实际问题和数据相融合的一个过程。假如你想更好地进行时间管理，可以试着把问题定义为：了解各小时的手机使用频率。接着，在获取和清理数据之后，先对频率数据进行分析，再以可视化的形式去说明自己的时间使用特点。
